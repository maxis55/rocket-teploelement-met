            ...
            <div class="inner_description">
                <div class="inner_description_flex">
                    ...
                    <div class="inner_description_text">
                        ...
                        <p>В качестве основного элемента соединения в магистральной трубопроводной системы используют
                            отводы стальные ГОСТ 17375, которые имеют крутоизогнутый вид и изменяют траекторию
                            направления потока для вещества во внутренней части трубы. Конструкционные элементы отводов
                            являются незаменимой частью целостной структуры магистрального трубопровода.</p>
