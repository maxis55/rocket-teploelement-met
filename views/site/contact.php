                        ...
                        <div class="contacts_info">
                            <div class="contacts_info_call">
                                ...
                                <div class="contacts_call_item">
                                    ...
                                    <a href="tel:<?=
                                    preg_replace("/[^0-9]/", "", $page_content['phone1']); ?>"
                                       class="header_info_lk"><?= $page_content['phone1'] ?></a>
                                </div>
                                <div class="contacts_call_item">
                                    <span>Звонок по России</span>
                                    <a href="tel:<?= preg_replace("/[^0-9]/", "", $page_content['phone2']); ?>"
                                       class="header_info_lk"><?= $page_content['phone2'] ?></a>
                                </div>
                                <div class="contacts_call_item">
                            ...
                            <div class="contacts_info_email">
                                <a href="mailto:<?= $page_content['email'] ?>"
                                   class="info_sub_lk"><?= $page_content['email'] ?></a>
                            </div>
                            <div class="contacts_info_data">
                                ...
                                <?php try {
                                    ...
                                    ?>
                                    <a href="<?= Media::findById($page_content['file'])->getImageOfSize() ?>"
                                       target="_blank" class="red_btn">Карта предприятия</a>
                                    <?php
