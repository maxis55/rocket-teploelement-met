    ...
    public function up()
    {
        ...
        $subcontent2='<h3>Обозначения, используемые <br> для отводов</h3>
                        <p>Согласно требованиям ГОСТ, к продукции предъявляется особая маркировка, которая позволяет
                            ...
                            <pre><img class="tiny-img" src="/uploads/image/chart1.png" alt="">
                            <img class="tiny-img" src="/uploads/image/chart2.png" alt="">
                            <img class="tiny-img" src="/uploads/image/chart3.png" alt=""></pre>
                            ';
